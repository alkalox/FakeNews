  ...
  render () {
    return ( 
      <div className="App">
        ...
        <p className ="textbox">
          We analyze a dataset of real and fake news in natural language processing toolkit(NLTK) and and scikit-learn for our machine learning algorithm to adapt and get better at recognizing fake news. We have used various sentiment analysis approaches to provide an accurate viewpoint. Support Vector Machine Algorithm has proven to be the most accurate in recognizing fake news, and thus we use that.
        </p>
      </div>
    )
  }
